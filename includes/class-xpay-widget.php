...
class Xpay_Widget {
	...
	private function render( $product_id ) {
		...
		$out .= '<div style="font-size:13px;color:#374151;font-weight:600;margin-bottom:8px;">' . esc_html__( 'Buy through your AI assistant', 'agentic-commerce-for-woocommerce' ) . '</div>';
