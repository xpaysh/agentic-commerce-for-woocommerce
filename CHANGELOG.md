...
- `is_storefront_widget_entitled()` now requires BOTH layers to be true before the
  ...
  ALONE no longer surfaces the widget. Fixes the a live merchant store 2026-06-25 case where
...
- The cart deeplink handler now passes the variation attribute map
  ...
  the exact bug the a live merchant store merchant hit on 2026-06-25.
